...
class UpsamplerBlock2(nn.Module):
    def __init__(self, ninput, noutput):
        super().__init__()
        self.conv = nn.ConvTranspose2d(ninput, noutput, 3, stride=4, padding=1, output_padding=1, bias=True)
        self.bn = nn.BatchNorm2d(noutput, eps=1e-3)
        self.relu = nn.ReLU6(inplace=True)
...
class zyz_ZNet(nn.Module):
    def __init__(self, classes=19, block_1=3, block_2=6):
        ...
        self.upsample_5 = UpsamplerBlock2(259, classes)
    ...
    def forward(self, input):
        ...
        out2 = self.upsample_5(output2_cat)#[1, 19, 256, 512]
